...
Prentice-Hall. 2000.\\
D'AMORE, Roberto. VHDL: Descrição
...
ÁREA: \\
CARGA HORÁRIA TOTAL: 60 HORAS NÚMERO DE CRÉDITOS: 04\\
CARGA HORÁRIA SEMANAL: 04 TEÓRICAS: 02h PRÁTICAS: 02h TOTAL: 04h\\
PRÉ-REQUISITOS: Engenharia de Software e Metodologia Científica\\
CO-REQUISITOS: não há

EMENTA 

Introdução à Engenharia de Software Experimental. Processo de condução de estudos experimentais. Estudos Primários e Secundários. Métodos quantitativos e qualitativos em engenharia de software. Engenharia de software baseada em evidências. Planejamento de experimentos e análise de resultados. Estatística Aplicada a Estudos Experimentais.

BIBLIOGRAFIA 

Básica:\\
Juristo, N., Moreno, A. M. Basics of software engineering experimentation. Springer Science \& Business Media. 2013.\\
Kitchenham, B. A., Budgen, D., Brereton, P. Evidence-Based Software engineering and systematic reviews (Vol. 4). CRC Press. 2015.\\
TRAVASSOS, G. H.; GUROV, D.; AMARAL, E. A. G. D. Introdução à Engenharia de Software Experimental: Relatório Técnico. COPPE/UFRJ, Rio de Janeiro. 2002.\\
Complementar:\\
...
Natalia Juristo and Ana M. Moreno. Basics of Software Engineering Experimentation. Kluwer Academic Publishers. 2001.\\
