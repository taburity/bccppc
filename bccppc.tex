...
\begin{center} 
\includegraphics[scale=0.25]{images/235_Marca_UFRPE_RGB_Gradiente_2.jpg} \\

 %{\scshape Universidade Federal Rural de Pernambuco\\}
...
\begin{itemize}
  \item Coordenação do Curso (e-mail): \href{mailto:coordenacao.bcc@uag.ufrpe.br}{coordenacao.bcc@uag.ufrpe.br}
...
\noindent Prof. Sérgio Francisco Tavares de Oliveira Mendonça\\
\url{http://bcc.uag.ufrpe.br/\~sftom}
...
\chapter*[Identificação do Curso de Graduação]{Identificação do Curso de Graduação}
\addcontentsline{toc}{chapter}{Identificação do Curso de Graduação}

A Tabela~\ref{ltab:DadosCaracteristicas} apresenta os parâmetros de caracterização de oferta do curso de
...
\begin{longtable}{ll}
 ...
 \label{ltab:DadosCaracteristicas}
\\
\hline
...
\section{Estágio curricular supervisionado}

O Estágio Curricular Supervisionado e Obrigatório, fazendo parte da matriz curricular,
constitui-se num espaço de aprendizagem concreta de vivência prática. 

O objetivo central se direciona na aplicação dos conhecimentos científicos adquiridos
durante a realização do Curso e a vivência profissional.

Os mecanismos de  acompanhamento e de cumprimento serão estabelecidos e acompanhados pelo Coordenador do
Curso em conjunto com a Comissão de Estágio e Professor responsável pelo Estágio. 

As atividades referentes ao Estágio poderão ser encontradas em Instruções para Estágio, documento aprovado pelo Colegiado de Coordenação Didática do Curso de Bacharelado em Ciência da Computação (CCD/BCC), contendo o detalhamento das atividades permitidas, inclusive a possibilidade, mediante aprovação do CCD/BCC, de participação em Projetos de Pesquisa, Empresa Júnior, \ldots, roteiro, relatórios, especificações detalhadas para a realização do Estágio Supervisionado, tendo em vista que a região ainda não possui um número de empresas produtoras de \textit{Software} com reconhecida competência e em número significativo para o adequado desenvolvimento do Estágio. Convém ressaltar que estágio relevante para egresso deste curso envolve a produção de \textit{Software} através de processos bem definidos e institucionalizados.

 Estes, resumidamente, consistem sistematicamente nas seguintes etapas:

\subsection{Fase 1 -- Plano de Estágio}

Elaboração, em conjunto com o professor-orientador de estágio e o
responsável técnico da empresa, do Plano de Estágio, a ser entregue junto à
Coordenação do Curso, até um prazo máximo de 30 (trinta) dias após o início do
estágio;

\subsection{Fase 2 -- Relatório Técnico de Estágio}

Elaboração, durante a realização do estágio, do Relatório Técnico de
Estágio, através de discussões realizadas entre o acadêmico, o professor-orientador e o
supervisor do estagiário na empresa; 

\subsection{Fase 3 -- Defesa do Relatório de Estágio}

Apresentação oral do Relatório de  Estágio para uma Banca Examinadora
constituída pelo professor-orientador  e dois docentes do Curso ou externos a
este com a concordância da Coordenação e  um representante da cedente do
estágio, se houver interesse desta;

\subsection{Fase 4 -- Do Julgamento}

A nota final da disciplina será composta pela avaliação realizada pelo supervisor do
estagiário na empresa, através de preenchimento de formulário padrão encaminhado
pela Coordenação do Curso, conceito este responsável por 40\% da nota final. Os
60\% restantes referem-se à avaliação realizada pelo professor-orientador de
estágio e pela Banca Examinadora;

\subsection{Fase 5 -- Do Relatório Final de Estágio}

O acadêmico deverá apresentar, após a correção final do relatório,  duas cópias
impressas e encadernadas junto à Coordenação do Curso, das quais,  uma deverá
compor o acervo da Biblioteca da Unidade e outra retida pela Coordenação de Curso.
