...
A estrutura curricular proposta, (visualizar a Matriz Curricular no apêndice 1) possui uma carga-horária mínima de 3.200 (três mil e duzentas) horas para a integralização dos créditos exigidos para a obtenção do título de Bacharel em Ciência da Computação.
...
\begin{center}
  ...
  \begin{table}[!htb]
    ...
    \textbf{Total}                         & \multicolumn{1}{c}{3.200} & \multicolumn{1}{c}{238} & \multicolumn{1}{c}{100,0}    \\ \bottomrule
    \end{tabular}
  \end{table}
  \end{small}
  \end{center}

Para integralização das 3.200 (três mil e duzentas) horas da carga-horária mínima exigida, o aluno deverá cumprir esta carga-horária distribuída da seguinte forma: 
